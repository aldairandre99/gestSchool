        ...
        <div class="flex justify-between h-16">
                ...
                <div class="hidden space-x-3 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @role('director_geral|director_pedagogico|secretario')
                        <x-dropdown align="left" width="56">
                            <x-slot name="trigger">
                                <button class="inline-flex items-center px-1 pt-1 text-sm font-medium text-gray-500 hover:text-gray-700 focus:outline-none transition">
                                    Pessoas
                            ...
                            <x-slot name="content">
                                ...
                                <x-dropdown-link :href="route('funcionarios.index')">{{ __('Staff') }}</x-dropdown-link>
                                <x-dropdown-link :href="route('professores.index')">{{ __('Teachers') }}</x-dropdown-link>
                                <x-dropdown-link :href="route('alunos.index')">{{ __('Students') }}</x-dropdown-link>
                                <x-dropdown-link :href="route('encarregados.index')">{{ __('Guardians') }}</x-dropdown-link>
                            </x-slot>
                        </x-dropdown>
                        ...
                        <x-dropdown align="left" width="56">
                            ...
                            <x-slot name="content">
                                <x-dropdown-link :href="route('anos.index')">{{ __('Academic Years') }}</x-dropdown-link>
                                <x-dropdown-link :href="route('trimestres.index')">{{ __('Terms') }}</x-dropdown-link>
                                <x-dropdown-link :href="route('classes.index')">{{ __('Classes') }}</x-dropdown-link>
                                <x-dropdown-link :href="route('turmas.index')">{{ __('Class Groups') }}</x-dropdown-link>
                                <x-dropdown-link :href="route('disciplinas.index')">{{ __('Subjects List') }}</x-dropdown-link>
                                <x-dropdown-link :href="route('matriculas.index')">{{ __('Enrollments') }}</x-dropdown-link>
                                <x-dropdown-link :href="route('atribuicoes.index')">{{ __('Assignments') }}</x-dropdown-link>
                            </x-slot>
                        </x-dropdown>
                    @endrole
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6 gap-2">
                <div class="flex items-center text-xs gap-1">
                    <a href="{{ route('locale.switch', 'pt') }}" class="px-2 py-1 rounded {{ app()->getLocale() === 'pt' ? 'bg-gray-800 text-white' : 'text-gray-500 hover:text-gray-700' }}">PT</a>
                    <a href="{{ route('locale.switch', 'en') }}" class="px-2 py-1 rounded {{ app()->getLocale() === 'en' ? 'bg-gray-800 text-white' : 'text-gray-500 hover:text-gray-700' }}">EN</a>
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @role('director_geral|director_pedagogico|secretario')
                ...
                <x-responsive-nav-link :href="route('anos.index')">{{ __('Academic Years') }}</x-responsive-nav-link>
                <x-responsive-nav-link :href="route('classes.index')">{{ __('Classes') }}</x-responsive-nav-link>
                <x-responsive-nav-link :href="route('turmas.index')">{{ __('Class Groups') }}</x-responsive-nav-link>
                <x-responsive-nav-link :href="route('disciplinas.index')">{{ __('Subjects List') }}</x-responsive-nav-link>
                <x-responsive-nav-link :href="route('matriculas.index')">{{ __('Enrollments') }}</x-responsive-nav-link>
                <x-responsive-nav-link :href="route('atribuicoes.index')">{{ __('Assignments') }}</x-responsive-nav-link>
            ...
            @endhasanyrole
            <x-responsive-nav-link :href="route('comunicados.index')">{{ __('Announcements') }}</x-responsive-nav-link>
            @role('encarregado')
